...
- Benchmark helper: see `backend/benchmark.py` for an offline solver runner and `backend/README_BENCHMARK.md` for usage instructions (run the solver without starting the Flask backend).
